...
if(!bot_role) return message.reply(`:x: Anti Raid Sistemi Kapalı Açmak İçin --> **z!bot-koruma #kanal**`)
  
let arguman = args[0];
  
if (!arguman) return message.channel.send(`:x: Lütfen Bir Bot İD Si Girin. \n Eğer Botun Giriş İznini Kaldırmak İstiyorsanız z!botizni  botid `)
